...
print(colored(Colors.GREEN, "Sent Count: " + str(len(set(sent_addresses)))))
print(colored(Colors.ERROR, "Inbox Count: " + str(len(set(inbox_addresses)))))
...
with open("data/emails.csv", "w", newline="", encoding="utf-8") as csvfile:
    ...
    count += 1
print(colored(Colors.CYAN, f"Total No-Replys: {count}"))
